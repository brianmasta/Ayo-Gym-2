  ...
  <div class="container-fluid px-0">
    <div class="d-flex justify-content-between w-100" id="navbarSupportedContent">
      <div class="d-flex align-items-center">
        <!-- Search form -->
          <label id="clock" style="color: rgb(255, 255, 255)"; class="btn mx-1 me-2 btn-secondary"></label>
      </div>
      <!-- Navbar links -->
      <ul class="navbar-nav align-items-center">
        ...
        <li class="nav-item dropdown" >
          ...
          <span class="badge" style="color:black">Role: </span><span><span
              class="badge  bg-secondary">{{ auth()->user()->role }}</span></span>
          {{-- <a href="" id="clock">Jam</a> --}}
        ...
        <li class="nav-item dropdown ms-lg-3">
          <a class="nav-link dropdown-toggle pt-1 px-0" href="#" role="button" data-bs-toggle="dropdown"
            ...
            <div class="media d-flex align-items-center">
              <img class="avatar rounded-circle" alt="Image placeholder" src="/assets/img/team/user.jpg">
              <div class="media-body ms-2 text-dark align-items-center d-none d-lg-block">
                <span
                  class="mb-0 font-small fw-bold text-gray-900">{{  auth()->user()->name ? auth()->user()->name . ' ' . auth()->user()->last_name : 'User Name'}}</span>
              </div>
            </div>
          </a>
