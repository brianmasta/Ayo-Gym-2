<div>
    <title>Ayo Gym Dashboard - Barang</title>
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
        <div class="d-block mb-4 mb-md-0">
            ...
            <h2 class="h4">Daftar Barang</h2>
            {{-- <p class="mb-0">Your web analytics dashboard template.</p> --}}
        </div>
        <div class="btn-toolbar mb-2 mb-md-0">
            <a href="/add-barang" class="btn btn-sm btn-gray-800 d-inline-flex align-items-center">
        ...
        <div class="row justify-content-between align-items-center">
            <div class="col-9 col-lg-8 d-md-flex">
                <div class="input-group me-2 me-lg-3 fmxw-300">
                    ...
                    <input type="text" class="form-control" placeholder="Pencarian Paket Member">
                </div>
        ...
        <table class="table user-table table-hover align-items-center">
            <thead>
                <tr>
                    ...
                    <th class="border-bottom">Kategori</th>
                    <th class="border-bottom">Satuan</th>
                    <th class="border-bottom">Harga Beli</th>
                    <th class="border-bottom">Harga Jual</th>
                    <th class="border-bottom">Stok</th>
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        <span class="fw-normal">BR0001</span>
                    </td>
                    <td>
                        <span class="fw-normal">Creatine</span>
                    </td>
                    <td><span class="fw-normal">Suplement</span></td>
                    <td><span class="fw-normal">Biji</span></td>
                    <td><span class="fw-normal">Rp.100.000</span></td>
                    <td><span class="fw-normal">Rp.150.000</span></td>
                    <td><span class="fw-normal">4000</span></td>
                    <td>
                        <div class="btn-group">
