<div>
    <title>Ayo Gym Dashboard - Biaya Pendaftaran</title>
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
        <div class="d-block mb-4 mb-md-0">
            ...
            <h2 class="h4">Daftar Biaya Pendaftaran</h2>
            {{-- <p class="mb-0">Your web analytics dashboard template.</p> --}}
        </div>
        <div class="btn-toolbar mb-2 mb-md-0">
            <a href="/add-biaya-pendaftaran" wire:navigate class="btn btn-sm btn-gray-800 d-inline-flex align-items-center">
        ...
        <div class="row justify-content-between align-items-center">
            <div class="col-9 col-lg-8 d-md-flex">
                <div class="input-group me-2 me-lg-3 fmxw-300">
                    ...
                    <input type="text" class="form-control" placeholder="Pencarian biaya">
                </div>
        ...
        <table class="table user-table table-hover align-items-center">
            <thead>
                <tr>
                    ...
                    <th class="border-bottom">Nama Biaya</th>
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        <span class="fw-normal">Paket Glo</span>
                    </td>
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu dashboard-dropdown dropdown-menu-start mt-2 py-1">
                                <a class="dropdown-item d-flex align-items-center" href="/edit-biaya-pendaftaran">
