            ...
            <div class="row justify-content-center form-bg-image">
                ...
                <div class="col-12 d-flex align-items-center justify-content-center">
                    <div class="bg-white shadow border-0 rounded p-4 p-lg-5 w-100 fmxw-500">
                        ...
                        <form wire:submit="resetPassword" action="#" method="POST">
                            {{-- <input wire:model.live="token" type="hidden" name="token" value="..."> --}}
                            <!-- Form -->
                            <div class="mb-4">
                                <label for="email">Your Email</label>
                                <div class="input-group">
                                    <input wire:model.live="email" type="email" class="form-control" placeholder="example@company.com" id="email" required autofocus>
                                </div>  
