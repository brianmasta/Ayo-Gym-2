<div>
<title>Ayo Gym Dashboard - Paket Non Member</title>
    ...
    <div class="d-block mb-4 mb-md-0">
        <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
            <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                ...
                <li class="breadcrumb-item active" aria-current="page">Paket Non Member</li>
            </ol>
        </nav>
        <h2 class="h4">Daftar Paket Non Member</h2>
        {{-- <p class="mb-0">Your web analytics dashboard template.</p> --}}
    </div>
    <div class="btn-toolbar mb-2 mb-md-0">
        <a href="/add-paket-non-member" wire:navigate class="btn btn-sm btn-gray-800 d-inline-flex align-items-center">
    ...
    <table class="table user-table table-hover align-items-center">
        <thead>
            <tr>
                ...
                <th class="border-bottom">Nama Paket Program</th>
                <th class="border-bottom">Biaya</th>
        ...
        <tbody>
            <tr>
                ...
                <td>
                    <span class="fw-normal">Paket Gold</span>
                </td>
