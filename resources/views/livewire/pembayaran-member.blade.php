<div>
<title>Ayo Gym Dashboard - Pembayaran Member</title>
    ...
    <div class="d-block mb-4 mb-md-0">
        <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
            <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                ...
                <li class="breadcrumb-item active" aria-current="page">Pembayaran Member</li>
            </ol>
        </nav>
        <h2 class="h4">Daftar Pembayaran Member</h2>
        {{-- <p class="mb-0">Your web analytics dashboard template.</p> --}}
    </div>
    <div class="btn-toolbar mb-2 mb-md-0">
        <a href="/add-pembayaran-member" wire:navigate class="btn btn-sm btn-gray-800 d-inline-flex align-items-center">
    ...
    <div class="row justify-content-between align-items-center">
        <div class="col-9 col-lg-8 d-md-flex">
            <div class="input-group me-2 me-lg-3 fmxw-300">
                ...
                <input type="text" class="form-control" placeholder="Pencarian Pembayaran Member">
            </div>
    ...
    <table class="table user-table table-hover align-items-center">
        <thead>
            <tr>
                ...
                <th class="border-bottom">Tgl Pembayaran</th>
                <th class="border-bottom">ID Member</th>
                <th class="border-bottom">Nama Member</th>
                <th class="border-bottom">Total Pembayaran</th>
                <th class="border-bottom">Jenis Pembayaran</th>
        ...
        <tbody>
            <tr>
                ...
                <td>
                    <span class="fw-normal">12-04-2025</span>
                </td>
                <td><span class="fw-normal">AG00001</span></td>
                <td><span class="fw-normal">Brian Marandof</span></td>
                <td><span class="fw-normal">Rp.200.000</span></td>
                <td><span class="fw-normal">Pendaftaran</span></td>
